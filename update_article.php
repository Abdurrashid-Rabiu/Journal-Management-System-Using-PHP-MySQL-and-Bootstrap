                        ...
                        <?php
                            ...
                            if($result_set > 0){
                                while($row = mysqli_fetch_assoc($result)){
                                    echo "{$row['id']} --- {$row['journals_id']} --- {$row['article_name']} --- {$row['author_name']} --- {$row['date']} <a class='btn btn-danger' href='/journal/delete_article{$row['journals_id']}{$row['id']}.php'> Delete </a> <br /> <br />";
                                }
                            }
                        ?>
                    </div>
